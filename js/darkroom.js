    ...
    var Crop = Darkroom.Transformation.extend({
        ...
        CropZone = fabric.util.createClass(fabric.Rect, {
            _render: function(ctx) {
                ...
                ctx.scale(scaleX, scaleY), ctx.fillStyle = this._renderOverlay(ctx), 
                    void 0 !== ctx.setLineDash ? ctx.setLineDash([dashWidth, dashWidth]) : void 0 !== ctx.mozDash && (ctx.mozDash = [dashWidth, dashWidth]), 
                    ctx.strokeStyle = "rgba(0, 0, 0, 0.2)", this._renderBorders(ctx), 
                    this._renderGrid(ctx), ctx.lineDashOffset = dashWidth, 
                    ctx.strokeStyle = "rgba(255, 255, 255, 0.4)", 
                    this._renderBorders(ctx), this._renderGrid(ctx), 
